...
public class AdminGrantCommand extends Command {
	...
	public void onCall(JDA jda, Guild guild, TextChannel channel, Member invoker, Message message, List<String> args) {
		...
		if (!msg.equals(""))
			channel.sendMessage(new EmbedBuilder().addField("Behold our new masters.", msg, false).setColor(Color.green).build()).queue();
		BotControl.usage.makeAdmin(message.getMentionedUsers());
	}
