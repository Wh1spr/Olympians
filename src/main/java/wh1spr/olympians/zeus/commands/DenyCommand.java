...
public class DenyCommand extends Command {
	...
	public void onCall(JDA jda, Guild guild, TextChannel channel, Member invoker, Message message, List<String> args) {
		...
		if (!msg.equals(""))
			channel.sendMessage(new EmbedBuilder().addField("May these mortals live in eternal shame!", msg, false).setColor(Color.red).build()).queue();
		BotControl.usage.deny(message.getMentionedUsers());
	}
